...
const TITRE_HEADER =  "linear-gradient(to right, #4f8a68 0%, #6fa884 25%, #f8f6f0 50%, #6fa884 75%, #4f8a68 100%), linear-gradient(to bottom, #4f8a68 0%, #6fa884 20%, #f8f6f0 50%, #6fa884 80%, #4f8a68 100%)";
