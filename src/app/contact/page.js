...
const TITRE_HEADER =  "linear-gradient(to right, #4f8a68 0%, #6fa884 15%, #f8f6f0 35%, #f8f6f0 65%, #6fa884 85%, #4f8a68 100%), linear-gradient(to bottom, #4f8a68 0%, #6fa884 15%, #f8f6f0 35%, #f8f6f0 65%, #6fa884 85%, #4f8a68 100%)";
